...
use fcommon\models\Companyimages;
use yii\helpers\Arrayhelper;
use common\models\County;
use yii\bootstrap4\Modal;
$companies = Company::find()->joinWith('companyimages')->where(['CategoryId'=>3])->all();
	...
	<div class='row card'>
		...
		<div class="media p-1 m-5 h-100">
			...
			<span><a class='btn btn-dark reviewbtn btn-sm'>REVIEW US</a></span>
              ...
              <img class="d-flex align-self-start" src="<?=yii::$app->request->baseUrl.'/'.$kampuni->companyimages[0]->imagePath?>">
